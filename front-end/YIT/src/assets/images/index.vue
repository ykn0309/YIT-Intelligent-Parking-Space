    ...
    <div class="container" :class="{ 'sign-up-mode': signUpMode }">
      ...
      <div class="panels-container">
        <div class="panel left-panel">
          <div class="content">
            <h1 style="display: inline-block; margin-right: 20px;">欢迎使用</h1>
            <h1 style="display: inline-block; font-size: 40px;"> 易+PM</h1>
            <h3>基于Vue3 + Spring Boot的团队项目协作管理软件</h3>
           <p></p>
          </div>
        ...
        <div class="panel right-panel">
          <div class="content">
           <h1 style="display: inline-block; margin-right: 20px; font-size: 30px;">欢迎注册</h1>
           <h1 style="display: inline-block; margin-right: 100px; font-size: 40px;"> 易+PM</h1>
          </div>
